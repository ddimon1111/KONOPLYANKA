...
class BotControlWindow(QtWidgets.QWidget):
    ...
    def setup_ui(self) -> None:
        ...
        self.settings_box = QtWidgets.QPlainTextEdit()
        self.settings_box.setPlainText("Настройки таймеров редактируются в коде/JSON.")
        settings_tab = QtWidgets.QWidget()
        slay = QtWidgets.QVBoxLayout(settings_tab)
        slay.addWidget(self.settings_box)
    ...
    def refresh_logs(self) -> None:
        ...
        with open(LOG_FILE, "r", encoding="utf-8") as f:
            text = f.read()
        self.log_box.setPlainText(text[-20000:])
